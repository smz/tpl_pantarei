...
<?php
	...
	if($params->get('effect','normal') == 'mootools-slide'){
		if(!empty($mootoolsIntro)) echo '<span class="acymailing_mootoolsintro">'.$mootoolsIntro.'</span>'; ?>
		<div class="acymailing_mootoolsbutton" id="acymailing_toggle_<?php echo $formName; ?>">
			<span><a class="acymailing_togglemodule" id="acymailing_togglemodule_<?php echo $formName; ?>" href="#subscribe"><?php echo $mootoolsButton ?></a></span>
	<?php
	}
		...
		<div class="acymailing_module_form" >
			...
			<div class="acymailing_form">
					...
					foreach($fieldsToDisplay as $oneField){
						if(empty($extraFields[$oneField])) echo '<span class="onefield fieldacy'.$oneField.'" id="field_'.$oneField.'_'.$formName.'">';
						if($oneField == 'name' AND empty($extraFields[$oneField])){
							...
							if($extraFields[$oneField]->type == 'category'){
								...
								echo '<span class="onefield fieldacy'.$oneField.'" id="field_'.$oneField.'_'.$formName.'">';
								if($displayOutside){
						...
						if(empty($extraFields[$oneField])) echo '</span>';
					}
				...
				<?php }
				 ...
				 if($params->get('showterms',false)){
					echo '<span class="onefield fieldacyterms" id="field_terms_'.$formName.'">';
					?>
