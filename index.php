...
<?php endif;?>
<?php // -- Top (logo, language switcher, search) -- ?>
...
<!--[if lt IE 9)]>
<div class='alert alert-error' style='margin-top:40px;text-align:center;'><?php echo JText::_('SMZ_OLDBROWSER_ALERT') ?></div>
<![endif]-->
